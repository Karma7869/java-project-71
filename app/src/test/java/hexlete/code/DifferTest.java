...
*/
    ...
    public void testDifferJsonFormat() throws Exception {
        ...
        Path expectedOutputPath = Path.of("src/test/resources/expected_output.json");

        String expected = Files.readString(expectedOutputPath).trim();
        String result = Differ.generate(filePath1.toString(), filePath2.toString(), "json").trim();
